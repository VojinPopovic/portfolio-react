  ...
  return (
    <section className="home">
      <div ref={setRefs} className="vojin-container">
        ...
        <motion.img animate={animations} src={BlackBlob} alt="BlackBlob" />
      </div>
      <Card className="top-card">
        ...
        >
          <path
            d="M210 107.315C224.692 128.248 240.774 153.384 233.644 169.881C226.608 186.192 196.361 193.864 173.216 196.702C150.258 199.633 134.308 197.917 114.898 199.364C95.4883 200.811 72.6191 205.422 57.5247 196.896C42.4303 188.37 35.018 166.427 22.6805 136.169C10.4367 105.725 -6.91876 66.8714 3.12884 39.4651C13.0827 12.2451 50.3458 -3.34138 82.6178 0.746525C114.61 4.92707 141.516 28.9684 161.621 49.355C181.819 69.5552 195.308 86.3809 210 107.315Z"
            fill="#DA3636"
          />
        </svg>
