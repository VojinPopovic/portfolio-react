...
function TopCard() {
  ...
  return (
      <Card className="top-card">
        ...
        {/* prettier-ignore */}
        <motion.svg ref={setRefs} animate={animations} initial={{scale:"0"}} transition={{delay:1.5, duration:1}} width="236" height="202" viewBox="0 0 236 202" fill="none" xmlns="http://www.w3.org/2000/svg">
